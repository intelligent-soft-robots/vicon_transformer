...
bool matrix_almost_equal(const Eigen::MatrixXd &lhs, const Eigen::MatrixXd &rhs)
{
...
namespace Eigen
{
void PrintTo(const Vector3d &m, std::ostream *os)
{
    *os << std::endl << m.transpose() << std::endl;
}

void PrintTo(const Matrix4d &m, std::ostream *os)
{
